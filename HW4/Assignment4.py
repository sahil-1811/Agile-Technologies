...
class TestStringMethods(unittest.TestCase):
    ...
    def test_notequal(self):
        self.assertNotEqual(list_recent_births([]),[['US35', 'List Recent Births', '', True, 'Ranbeer Kapoor']])     
    ...
    def test_isin(self):
        self.assertIn("Ridhima Kapoor",list_recent_births([])[0])
    def test_isnotin(self):
        self.assertNotIn("Rishi Kapoor",list_recent_births([])[0])
